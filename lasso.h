...
#define WINDOW_X 800
#define WINDOW_Y 600
#define WINDOW_DIAGNAL sqrt(WINDOW_X*WINDOW_X+WINDOW_Y*WINDOW_Y)
...
#define COIN_ANGLE_DEG1 60
#define COIN_ANGLE_DEG2 120

#define BOMB_SPEED 100
#define BOMB_ANGLE_DEG 60
...
class Lasso : public MovingObject {
 ...
 Lasso(double speed, double angle_deg, double argax, double argay, bool argpaused, bool rtheta) : MovingObject(speed, angle_deg, argax, argay, argpaused, rtheta) {
  ...
  void check_for_pbomb(Bomb *p_bomb);
